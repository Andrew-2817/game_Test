...
async def start(message: Message):
    ...
    # Проверка, что команда вызвана в личном чате
    ...
    # Создаем список корутин для выполнения
    tasks = [
        add_user(user_id, username, join_date),  # Добавление пользователя
        add_shop(user_id),                       # Добавление магазина
        init_player_statistics(user_id)          # Инициализация статистики
    ]
    ...
    await message.answer_photo(
        ...
        caption=(
            ...
            'Здесь ты сможешь погрузиться в интересные игры, такие как "Цуефа 🪨✂️🧻", "Пенальти ⚽️", соревноваться с другими игроками и друзьями и повышать свое место в таблице лидеров.\n\n'
